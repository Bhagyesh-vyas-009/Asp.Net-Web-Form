...
namespace AddressBook.AdminPanel.FileContact
{
    public partial class FileContactAddEdit : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            conn.ConnectionString = ConfigurationManager.ConnectionStrings["FileUploadConnectionString"].ConnectionString;
            try
            {
                ...
                if (fuContactPhotoPath.HasFile)
                {
                    ...
                    ContactPhotoPath = "~/UserContent/" + strContactName.ToString() + DateTime.Now.ToString("ddMMyyyyyhh_mm_ss_fff") + System.IO.Path.GetExtension(fuContactPhotoPath.FileName.ToString().Trim());
                }
                else
                {
                ...
                lblMessage.Text = "File Name - " + fuContactPhotoPath.PostedFile.FileName + "<br/>";
                lblMessage.Text += "File Size - " + fuContactPhotoPath.PostedFile.ContentLength + "<br/>" + "Extension -" + System.IO.Path.GetExtension(fuContactPhotoPath.FileName);
        ...
        {
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["FileUploadConnectionString"].ConnectionString);
            try
            {
        ...
        {
            Response.Redirect("~/AdminPanel/FileContact/FileContactList.aspx");
        }
