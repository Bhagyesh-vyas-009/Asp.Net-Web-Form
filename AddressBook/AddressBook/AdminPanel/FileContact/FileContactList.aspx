<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AddressBook.Master" AutoEventWireup="true" CodeBehind="FileContactList.aspx.cs" Inherits="AddressBook.AdminPanel.FileContact.FileContactList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
   ...
   <div class="float-end">
       <asp:HyperLink ID="hlContactAdd" runat="server" NavigateUrl="~/AdminPanel/FileContact/FileContactAddEdit.aspx" class="btn btn-primary mb-3">Add Contact</asp:HyperLink>
   </div>
           ...
           <asp:TemplateField>
               <ItemTemplate>
                   ...
                   <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-warning btn-sm"
                       NavigateUrl='<%# "~/AdminPanel/FileContact/FileContactAddEdit.aspx?ContactID="+Eval("ContactID").ToString().Trim() %>' />
